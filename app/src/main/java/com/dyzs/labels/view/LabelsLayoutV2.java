 ...
 * create by maidou
 */
public class LabelsLayoutV2 extends ViewGroup {
    ...
    public LabelsLayoutV2(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }
    public LabelsLayoutV2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public LabelsLayoutV2(Context context) {
        super(context);
    }
    ...
    class Line {
        private ArrayList<View> viewList = new ArrayList<>();        // 用来记录当前行的所以 TextView
