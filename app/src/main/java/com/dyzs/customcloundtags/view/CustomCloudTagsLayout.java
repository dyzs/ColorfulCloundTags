 ...
 * create by maidou
 */
public class CustomCloudTagsLayout extends ViewGroup {
    ...
    private ArrayList<Line> lineList = new ArrayList<CustomCloudTagsLayout.Line>();
    public CustomCloudTagsLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }
    public CustomCloudTagsLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    public CustomCloudTagsLayout(Context context) {
        super(context);
    }
